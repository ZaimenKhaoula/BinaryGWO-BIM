...
ifc_file = ifcopenshell.open(r"C:\test1.ifc")
print("done.")
...
#nb_zones=15*5+5*2
zones, obstacles, dalles = getZones(ifc_file,1, 1.5, False, True)
print("nb zones  ", end="  ")
print(len(zones))
Rc = 6
Rs = 4
...
def solve(run):
    pop= create_pop()
    fichier="resultats_tout_test1_160_"+str(run)
